...
contract P6PlusOrbit is FreedomPlusBaseOrbit {
    ...
    function supportsLevel(uint8 level) public pure override returns (bool) { return level == 4; }
    function orbitType() public pure override returns (FreedomPlusConfig.OrbitType) {
        return FreedomPlusConfig.OrbitType.P6;
    }
}
