...
contract P39PlusOrbit is FreedomPlusBaseOrbit {
    ...
    function supportsLevel(uint8 level) public pure override returns (bool) { return level == 1; }
    function orbitType() public pure override returns (FreedomPlusConfig.OrbitType) {
        return FreedomPlusConfig.OrbitType.P39;
    }
}
