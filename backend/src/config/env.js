...
const env = {
  ...
  FREEDOM_PLUS_ENABLED: optionalBoolean('FREEDOM_PLUS_ENABLED', false),
  FREEDOM_PLUS_REALTIME_ENABLED: optionalBoolean('FREEDOM_PLUS_REALTIME_ENABLED', false),
  FREEDOM_PLUS_POLLING_ENABLED: optionalBoolean('FREEDOM_PLUS_POLLING_ENABLED', false),
  FREEDOM_PLUS_START_BLOCK: Math.max(
    0,
    optionalInteger('FREEDOM_PLUS_START_BLOCK', 0)
  ),
  FREEDOM_PLUS_REGISTRATION_ADDRESS: optional('FREEDOM_PLUS_REGISTRATION_ADDRESS'),
  FREEDOM_PLUS_LEVEL_MANAGER_ADDRESS: optional('FREEDOM_PLUS_LEVEL_MANAGER_ADDRESS'),
  FREEDOM_PLUS_SETTLEMENT_ROUTER_ADDRESS: optional('FREEDOM_PLUS_SETTLEMENT_ROUTER_ADDRESS'),
  FREEDOM_PLUS_P39_ORBIT_ADDRESS: optional('FREEDOM_PLUS_P39_ORBIT_ADDRESS'),
  FREEDOM_PLUS_P14_ORBIT_ADDRESS: optional('FREEDOM_PLUS_P14_ORBIT_ADDRESS'),
  FREEDOM_PLUS_P12_ORBIT_ADDRESS: optional('FREEDOM_PLUS_P12_ORBIT_ADDRESS'),
  FREEDOM_PLUS_P6_ORBIT_ADDRESS: optional('FREEDOM_PLUS_P6_ORBIT_ADDRESS'),
  FREEDOM_PLUS_P4_ORBIT_ADDRESS: optional('FREEDOM_PLUS_P4_ORBIT_ADDRESS'),
  FREEDOM_PLUS_P3_ORBIT_ADDRESS: optional('FREEDOM_PLUS_P3_ORBIT_ADDRESS'),
  FREEDOM_PLUS_FPT_ADDRESS: optional('FREEDOM_PLUS_FPT_ADDRESS'),
  FREEDOM_PLUS_FPTR_ADDRESS: optional('FREEDOM_PLUS_FPTR_ADDRESS'),
  FREEDOM_PLUS_TOKEN_CONTROLLER_ADDRESS: optional('FREEDOM_PLUS_TOKEN_CONTROLLER_ADDRESS'),
  FREEDOM_NFT_MEMBERSHIP_ADDRESS: optional('FREEDOM_NFT_MEMBERSHIP_ADDRESS'),
  FREEDOM_NFT_REWARD_DISTRIBUTOR_ADDRESS: optional('FREEDOM_NFT_REWARD_DISTRIBUTOR_ADDRESS'),
  FREEDOM_NFT_POOL_VAULT_ADDRESS: optional('FREEDOM_NFT_POOL_VAULT_ADDRESS'),
  FREEDOM_PLUS_OPERATIONS_VAULT_ADDRESS: optional('FREEDOM_PLUS_OPERATIONS_VAULT_ADDRESS'),
  ...
  STAGING_TEST_ADMIN_ENABLED: optionalBoolean('STAGING_TEST_ADMIN_ENABLED', false),
...
if (env.FREEDOM_PLUS_ENABLED) {
  const requiredFreedomPlusVariables = [
    ...
    'NFT_POOL_VAULT_ADDRESS',
    'OPERATIONS_VAULT_ADDRESS',
  ];
  for (const name of requiredFreedomPlusVariables) {
    if (!env[name]) throw new Error(`Missing required env variable because FREEDOM_PLUS_ENABLED=true: ${name}`);
  }
}
